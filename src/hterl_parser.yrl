...
tags tag self_closing_tag tag_open tag_close tag_start_attrs tag_attr tag_attrs
...
tag_start_attrs -> tag_start : {tag, ?anno('$1'), element(3, '$1'), [], []}.
tag_start_attrs -> tag_start tag_attrs : {tag, ?anno('$1'), element(3, '$1'), '$2', []}.
...
tag -> tag_open exprs tag_close : build_tag('$1', '$3', '$2').

tag_attrs -> tag_attr : ['$1'].
tag_attrs -> tag_attr tag_attrs : ['$1' | '$2'].

tag_attr -> atom : {min_attr, ?anno('$1'), element(3, '$1')}.
tag_attr -> atom '=' expr_max : {attr, ?anno('$1'), element(3, '$1'), '$3'}.

expr_max -> tags : '$1'.

tags -> tag : {tags, ?anno('$1'), ['$1']}.
tags -> tag tags : {tags, ?anno('$1'), ['$1' | element(3, '$2')]}.
...
%% build_tag
build_tag({tag, A, OpenName, Attrs, []}, CloseName, Exprs) ->
	case OpenName =:= CloseName of
		true ->
			{tag, A, OpenName, Attrs, Exprs};
		false ->
             		ret_err(A, "tag mismatch")			
	end.
